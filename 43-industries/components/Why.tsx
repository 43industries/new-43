...
const functions = [
  ...
  },
  {
    ...
    desc: "In a world of volatile digital instruments, precious metals provide a bedrock of real, physical value. Gold. Silver. Copper. Time-tested. Inflation-resistant.",
    returnVal: '"permanent_store_of_value"',
    returnClass: "str",
    delay: 0.3,
  },
];
